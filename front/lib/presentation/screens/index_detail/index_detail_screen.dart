...
class IndexDetailPage extends ConsumerWidget {
  ...
  String _getIndexDescription(String indexName) {
    switch (indexName) {
      ...
      case '미세먼지 지수':
        return '지름이 10마이크로미터 이하인 먼지로, 공장, 자동차 등에서 배출되며 대기 중에 떠다니는 입자입니다.';
      case '심뇌혈관질환 지수':
        return '기온, 습도 등 기상 조건을 종합해 심장 및 뇌혈관 질환 발생 가능성을 나타내는 지표입니다.';
      case '천식질환 지수':
        return '기상 요소를 바탕으로 천식이나 폐 관련 질환의 발생 위험 수준을 수치로 표현한 지표입니다.';
      case '감기가능 지수':
        return '일교차, 기온 등의 기상 요소를 고려해 감기 발생 가능성을 수치로 표현한 지표입니다.';
      case '식중독 지수':
        return '기온과 습도 등의 환경 조건을 기반으로 식중독 발생 가능성을 백분율로 나타낸 지표입니다.';
      case '자외선 지수':
        return '태양의 고도와 위치를 고려하여 지표면에 도달하는 자외선 강도를 수치화한 지표입니다.';
      // ... 다른 지수 설명 추가 ...
      default:
