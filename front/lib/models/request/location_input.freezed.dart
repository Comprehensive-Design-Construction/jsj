...
abstract class $LocationInputCopyWith<$Res> {
  factory $LocationInputCopyWith(
    LocationInput value,
    $Res Function(LocationInput) then,
...
abstract class _$$LocationInputImplCopyWith<$Res>
  ...
  factory _$$LocationInputImplCopyWith(
    _$LocationInputImpl value,
    $Res Function(_$LocationInputImpl) then,
...
class __$$LocationInputImplCopyWithImpl<$Res>
  ...
  __$$LocationInputImplCopyWithImpl(
    _$LocationInputImpl _value,
    $Res Function(_$LocationInputImpl) _then,
  ) : super(_value, _then);
...
class _$LocationInputImpl implements _LocationInput {
  const _$LocationInputImpl({required this.latitude, required this.longitude});
  ...
  Map<String, dynamic> toJson() {
    return _$$LocationInputImplToJson(this);
  }
}

abstract class _LocationInput implements LocationInput {
  const factory _LocationInput({
